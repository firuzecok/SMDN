...
public class AutomationStepDefinitions {
    ...
    public void user_create_and_account_bolumune_email_adresi_girer() {
      //  automationPage.emailTextBox.sendKeys(faker.internet().emailAddress());
        automationPage.emailTextBox.sendKeys("java.mail.com");
    ...
    @Then("hesap olustugunu dogrulayi")
    public void hesap_olustugunu_dogrulayi() {
        Assert.assertTrue(automationPage.positiveResultText.isDisplayed());

    }

    @And("user mesaji dogrulayin")
    public void userMesajiDogrulayin() {
        Assert.assertTrue(automationPage.createAccountErrorYazisi.isDisplayed());
    }
}
