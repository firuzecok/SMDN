...
public class EcxelStepDefinitions {

    Workbook workbook;
    @Given("kullanici ecxel dosyasini  kullanilabilir hale getirir")
    public void kullanici_ecxel_dosyasini_kullanilabilir_hale_getirir() throws IOException {
    ...
    public void baskenti_jakarta_olan_ulke_ismini_yazdirir() {
        // for loop ile tum satirlari kontrol etmem gerekiyor bunun icin satir sayısına ihtiyacim var
    ...
    public void fiziki_olarak_kullanilan_satir_sayisinin_oldugunu_test_eder(Integer fizikiKullanilanSatir) {
        int actualFizikiKullanilanSatir=workbook.getSheet("Sayfa1")
